...
namespace FileBackuper
{
    public static class FileBackuperLib
    {
        public static string CreateDestinationDir()
        {
            ...
            Console.WriteLine($"Machine name: {compName}");
            ...
            Console.WriteLine($"Destination directory: {newDir}");
        ...
        public static List<FileInfo> SmartSort(List<FileInfo> files)
        {
            ...
            Console.WriteLine($"Sorted list size = {sortedList.Count}");
            return sortedList;
        }
        ...
        public static bool IsFileShouldBeSkipped(FileInfo fi)
        {
            ...
            {
                //Console.WriteLine($"Skip file by size ({fi.Length}) - {fi.Name}");
                return true;
            }
            ...
            {
                Console.WriteLine($"Skip file by film name - {fi.Name}");
                return true;
            }
